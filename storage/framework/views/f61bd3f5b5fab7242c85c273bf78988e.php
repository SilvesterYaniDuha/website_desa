    ...
    Desa Purbalingga
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('profil') ? 'active' : ''); ?>" href="<?php echo e(route('profil')); ?>">Profil Desa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('layanan') ? 'active' : ''); ?>" href="<?php echo e(route('layanan')); ?>">Layanan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('galeri') ? 'active' : ''); ?>" href="<?php echo e(route('galeri')); ?>">Galeri</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('kontak') ? 'active' : ''); ?>" href="<?php echo e(route('kontak')); ?>">Kontak</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <p><i class="bi bi-envelope"></i> info@desa<?php echo e(strtolower(config('app.name'))); ?>.id</p>
                </div>
                <div class="col-md-4 mb-3">
                    <h5>Tautan Cepat</h5>
            ...
            <div class="text-center">
                <p>&copy; <?php echo e(date('Y')); ?> Desa <?php echo e(config('app.name')); ?>. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\Users\User\website-desa\resources\views/layouts/app.blade.php ENDPATH**/ ?>